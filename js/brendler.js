...
document.querySelectorAll('.brend').forEach(brend=>{
...
const komo = document.querySelector('.komoimg');
const slobodo = document.querySelector('.slobodoimg');
const brendParent = document.querySelectorAll('.brend-parent section');
const komoAbout = document.querySelector('.komo');
const slobodoAbout = document.querySelector('.sloboda');


komo.addEventListener('click',()=>{
    brendParent.forEach(sec=>{
        sec.classList.remove('active')
    })
   komoAbout.classList.add('active')
})

slobodo.addEventListener('click',()=>{
    brendParent.forEach(sec=>{
        sec.classList.remove('active')
    })
   slobodoAbout.classList.add('active')
})
