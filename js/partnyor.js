...
/* partnyor body start */
const partnyor = document.querySelectorAll('.partnyor');
const next = document.querySelector('.next');
const prew = document.querySelector('.prew');
const pClassChild = document.querySelectorAll('.pClass p');
const pClass = document.querySelectorAll('.pClass');
const partnyorBody = document.querySelectorAll('.partnyor-body .page');
let number = partnyorBody.length;
