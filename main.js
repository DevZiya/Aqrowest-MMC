...
/* sectinon 2 start */
let prew = document.querySelector('.swiper-button-prev')
let next = document.querySelector('.swiper-button-next')
let prew1 = document.querySelector('.swiper-button-prev1')
let next1 = document.querySelector('.swiper-button-next1')
